...
Run this script from the directory containing the bitcoin, gitian-builder, gitian.sigs.BRC, and berycoin-detached-sigs.
...
then
	...
	then
	    ...
	    ./bin/gsign -p $signProg --signer $SIGNER --release ${VERSION}-linux --destination ../gitian.sigs.BRC/ ../berycoin/contrib/gitian-descriptors/gitian-linux.yml
	...
	then
	    ...
	    ./bin/gsign -p $signProg --signer $SIGNER --release ${VERSION}-win-unsigned --destination ../gitian.sigs.BRC/ ../berycoin/contrib/gitian-descriptors/gitian-win.yml
	...
	then
	    ...
	    ./bin/gsign -p $signProg --signer $SIGNER --release ${VERSION}-osx-unsigned --destination ../gitian.sigs.BRC/ ../berycoin/contrib/gitian-descriptors/gitian-osx.yml
	...
	popd
        ...
        if [[ $commitFiles = true ]]
        then
	    # Commit to gitian.sigs.BRC repo
            echo ""
...
then
	...
	then
	    ...
	    ./bin/gsign -p $signProg --signer $SIGNER --release ${VERSION}-win-signed --destination ../gitian.sigs.BRC/ ../berycoin/contrib/gitian-descriptors/gitian-win-signer.yml
	...
	then
	    ...
	    ./bin/gsign -p $signProg --signer $SIGNER --release ${VERSION}-osx-signed --destination ../gitian.sigs.BRC/ ../berycoin/contrib/gitian-descriptors/gitian-osx-signer.yml

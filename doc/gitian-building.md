...
in `gitian.sigs.BRC` to your signing machine and do
...
[gitian.sigs.BRC](https://github.com/berycoin-project/gitian.sigs.BRC/) repository, or if that's not possible create a pull
